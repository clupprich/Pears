...
<?php while ( have_posts(array('cat' => array(1))) ) : the_post(); ?>
  ...
  <div id="pattern" class="mod group">
		...
		<div class="group">
			...
			<div id="code" class="mod">
				<h3 class="label">JS</h3> <a href="#" class="clip" title="select code for copying"><img src="<?php bloginfo('template_directory'); ?>/images/icon-copy.png" alt="copy" /></a>
